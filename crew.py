...
email_writer_agent = build_email_writer_agent()
...
email_writer_task = build_email_writer_task(email_writer_agent, analysis_task)

crew = Crew(
    agents=[resume_agent, jd_agent, analysis_agent, email_writer_agent],
    tasks=[resume_task, jd_task, analysis_task, email_writer_task],
    verbose=True
)
